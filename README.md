...
alex@ubuntu:~/c/printf$ gcc -Wall -Wextra -Werror
...
We strongly encourage you to work all together on a
set of tests
...
Handle the following flag characters for non-custom
